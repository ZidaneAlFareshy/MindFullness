document.addEventListener("DOMContentLoaded", function () {
  ...
  btnYes.addEventListener("click", function () {
    showPopup("Yup Anda Benar!! karena pada kasus tertentu mereka bisa menyakiti diri sendiri dan mencoba bunuh diri.");
    btnYes.classList.add("active");
    btnNo.classList.remove("active");
  });

  btnNo.addEventListener("click", function () {
    showPopup("Opps Anda Salah!! karena pada kasus tertentu mereka bisa menyakiti diri sendiri dan mencoba bunuh diri.");
